...
export default function DivisionMemoranda() {
  const [searchQuery, setSearchQuery] = useState("");

  const mockDocs = [
    { id: 1, num: "DM No. 045, s. 2024", title: "ADMINISTRATION OF THE 2024 NATIONAL ACHIEVEMENT TEST FOR GRADE 6", date: "April 05, 2024", size: "450 KB" },
    { id: 2, num: "DM No. 044, s. 2024", title: "COMPOSITION OF THE DIVISION SELECTION COMMITTEE FOR TEACHER I POSITIONS", date: "April 03, 2024", size: "1.2 MB" },
    { id: 3, num: "DM No. 043, s. 2024", title: "SUBMISSION OF INVENTORY OF LEARNERS WITH DISABILITIES FOR SY 2023-2024", date: "April 01, 2024", size: "320 KB" },
    { id: 4, num: "DM No. 042, s. 2024", title: "DIVISION CONTEXTUALIZATION OF LEARNING RESOURCES IN ELEMENTARY SCIENCE", date: "March 28, 2024", size: "2.1 MB" },
    { id: 5, num: "DM No. 041, s. 2024", title: "SCHEDULE OF THE 2024 DIVISION FESTIVAL OF TALENTS (DFOT)", date: "March 25, 2024", size: "890 KB" },
    { id: 6, num: "DM No. 040, s. 2024", title: "DISSEMINATION OF OFFICE ORDER ON THE RECONSTITUTION OF THE PRAISE COMMITTEE", date: "March 20, 2024", size: "560 KB" },
  ];
  ...
  return (
    <div className="w-full bg-[#f8fafc] min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900 pb-32">
      ...
      <section className="relative h-[450px] md:h-[550px] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 w-full space-y-12 mt-12">
           ...
           <div className="relative group max-w-3xl">
              ...
              <input 
                 type="text" 
                 placeholder="Search by Keyword, Title, or Memorandum Number..."
                 value={searchQuery}
      ...
      {/* Result Grid - Simplified Vertical List */}
      <div className="max-w-5xl mx-auto px-6 -mt-32 relative z-20 space-y-8">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-2xl p-4 border border-white shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4">
           <div className="flex items-center gap-4 text-slate-500">
              <Filter size={18} />
              <span className="text-[10px] font-black uppercase tracking-widest">Current View:</span>
              <div className="px-3 py-1 bg-blue-100 text-blue-600 rounded-lg text-[10px] font-black uppercase">Year 2024</div>
           </div>
           <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Showing {mockDocs.length} Documents</p>
        </div>
        ...
        <div className="bg-slate-50/50 rounded-[3rem] p-16 border-2 border-dashed border-slate-200 text-center space-y-6">
           ...
           <div className="space-y-2">
              <h4 className="text-xl font-black text-slate-900 uppercase">Reached the end of 2024</h4>
              <p className="text-slate-500 text-sm font-medium">Looking for older files? Use the archive filters or search at the top.</p>
           </div>
           <button className="px-8 py-4 bg-white border border-slate-200 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-slate-900 hover:text-white transition-all">
              Load Previous Year
           </button>
        </div>
