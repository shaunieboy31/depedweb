      ...
      content: (
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="w-full md:w-1/3 rounded-xl overflow-hidden shadow-lg border-2 border-white">
            <img src="/images/newbuilding.webp" alt="SDO Imus Building" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500" />
          </div>
        </div>
      ),
    },
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white/60 p-5 rounded-lg border border-emerald-100/50 shadow-sm hover:shadow-md transition flex gap-4 items-start">
              ...
              <span className="text-gray-700 text-lg">Students learn in a child-friendly, gender-sensitive, safe, and motivating environment</span>
            </div>
            <div className="bg-white/60 p-5 rounded-lg border border-emerald-100/50 shadow-sm hover:shadow-md transition flex gap-4 items-start">
              <span className="text-3xl text-emerald-500">👩‍🏫</span>
              <span className="text-gray-700 text-lg">Teachers facilitate learning and constantly nurture every learner</span>
            </div>
            <div className="bg-white/60 p-5 rounded-lg border border-emerald-100/50 shadow-sm hover:shadow-md transition flex gap-4 items-start">
              <span className="text-3xl text-emerald-500">🏢</span>
              <span className="text-gray-700 text-lg">Administrators and staff, as stewards of the institution, ensure an enabling and supportive environment for effective learning to happen</span>
            </div>
            <div className="bg-white/60 p-5 rounded-lg border border-emerald-100/50 shadow-sm hover:shadow-md transition flex gap-4 items-start">
              <span className="text-3xl text-emerald-500">🤝</span>
              <span className="text-gray-700 text-lg">Family, community, and other stakeholders are actively engaged and share responsibility for developing life-long learners</span>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="w-full md:w-1/3 rounded-xl overflow-hidden shadow-lg border-2 border-white">
            <img src="/images/deped-division-office-imus.webp" alt="Historical DepEd Context" className="w-full h-auto object-cover hover:scale-105 transition-transform duration-500" />
          </div>
          <div className="flex-1 space-y-4">
            <p className="text-gray-700 leading-relaxed text-lg">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-wrap justify-center gap-6 py-4">
          {["Maka-Diyos", "Maka-tao", "Makalikasan", "Makabansa"].map((value, i) => (
            <div key={i} className="bg-white/80 px-8 py-6 rounded-2xl shadow-sm border border-pink-200 text-center hover:-translate-y-1 transition-transform duration-300 min-w-[200px]">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={i} className="bg-white/60 p-4 rounded-lg flex items-center gap-3 border border-cyan-100 hover:bg-white hover:shadow-md transition-all">
                <div className="min-w-6 w-6 h-6 rounded-full bg-cyan-500 text-white flex items-center justify-center text-sm font-bold">✓</div>
                <span className="text-gray-700 font-medium text-sm md:text-base">{obj}</span>
              </div>
            ))}
          </div>
          <div className="mt-8 bg-white/70 p-6 rounded-xl border border-cyan-200/50 shadow-inner">
            <p className="text-gray-700 leading-relaxed text-center italic font-medium">
              The Department upholds the highest standards of conduct and performance to fulfill stakeholders' needs and expectations by adhering to constitutional mandates, statutory, and regulatory requirements, and sustains client satisfaction through continuous improvement of the <strong>Quality Management System</strong>.
            </p>
          </div>
        </div>
      ),
      ...
      <section className="relative overflow-hidden bg-[#032977] text-white py-16 lg:py-24 px-4 lg:px-8 shadow-2xl mb-12 rounded-b-[3rem]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <p className="content-center text-xl text-blue-100 max-w-2xl mx-auto font-light leading-relaxed">
            Discover the rich history, mandate, and guiding principles that fuel our passion for quality education.
          </p>
        </div>
      </section>
          ...
          {sections.map((sec, idx) => (
            ...
            >
              <div className="mb-6 md:mb-8">
                ...
                <div className={`mt-4 h-1.5 w-24 md:w-32 rounded-full shadow-sm ${sec.colorTheme.divider}`} />
              </div>
              <div className="pt-2">
                {sec.content}
              </div>
