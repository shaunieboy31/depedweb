    ...
    <div className="w-full">
      <section className="px-4 lg:px-16 py-16">
        <div className="max-w-4xl">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Division Profile</h1>
          
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-blue-600 mb-4">About Schools Division Office of Imus City</h2>
              <p>
                The Schools Division Office of Imus City is committed to providing quality, equitable, culture-based, and complete basic education to all learners in Imus City. The division operates under the Department of Education and aims to implement national education policies and programs at the local level.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>Administrators and staff, as stewards of the institution, ensure an enabling and supportive environment for effective learning</li>
                <li>Family, community, and other stakeholders are actively engaged in developing life-long learners</li>
              </ul>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-blue-600 mb-4">Key Statistics</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-blue-600 mb-4">Quality Policy</h2>
              <p>
